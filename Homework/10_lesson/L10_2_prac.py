...
class MaterialLenSolver:
    ...
    @property
    def node_list(self):
        return {"Coats": self.__coat_list, "Costumes": self.__costume_list}
    ...
    def node_list(self, other, add=True):
        if other.__class__ is Coat:
            ...
            raise ValueError("Unknown cloth type")
...
coat = Coat("ZXC", 56)
print(coat.material_length())

costume = Costume('ABC', 179)
print(costume.material_length())